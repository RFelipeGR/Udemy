...
int main(){
    ...
    float primedio_temp_alta=suma_temp_alta/3;
    printf("primedio temp baja: %.2f\npromedio temp media: %.2f\npromedio temp alta: %.2f",promedio_temp_baja,promedio_temp_media,primedio_temp_alta);
    return 0;
}